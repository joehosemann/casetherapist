var initClosed = function () {
    //var theme = getDemoTheme();
    var url = "http://bbecweb:8012/hapi/Cases/?type=tamclosed&workable=-1&resolved=-1&param=" + _param;
    //console.log(url);
    ...
    grid.jqxGrid(
    {
        ...
        ready: function () {
            ...
            $('#pagerjqxgridClosed>div').append('<input style="float: left; margin-left: 5px; padding: 1px 5px; font-size: .9em;" type="button" value="Export to CSV" id="csvExportClosed" />')
            $("#csvExportClosed").jqxButton({ theme: "metro-lime" });
