var initResolved = function () {
    ...
    var url = "http://bbecweb:8012/hapi/Cases/?type=analyst&workable=-1&resolved=1&param=" + _param;
    //console.log(url);
    ...
    var cellsrenderer = function (row, columnfield, value, defaulthtml, columnproperties, rowData) {
        ...
        switch (columnproperties.classname) {
            ...
            default:
                ...
                var centeredColumns = ["colheaderCaseNum", "colheaderSeverity", "colheaderContacted", "colheaderUpdated", "colheaderProduct", "colheaderCaseAge", "colheaderDaysOwned"];
    ...
    grid.jqxGrid(
    {
        ...
        columns: [
			...
			//{ text: 'WI', datafield: 'WI', width: '0px', classname: 'colheaderWI', cellsrenderer: cellsrenderer },
